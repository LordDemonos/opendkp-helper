...
(function (global) {
  ...
  var GLOBAL_COOLDOWN_MS = 20000;
  var LAST_AT_KEY = 'opendkpReload:lastAt';

  var LIMITS = {
    disconnect: { maxAttempts: 3, windowMs: 5 * 60 * 1000, key: 'opendkpReload:disconnect' },
    stale: { maxAttempts: 2, windowMs: 10 * 60 * 1000, key: 'opendkpReload:stale' },
    'raid-missing': { maxAttempts: 2, windowMs: 10 * 60 * 1000, keyPrefix: 'opendkpReload:raid:' }
  };
